...
def load_model(model_name, quantization) -> LlamaForCausalLM:
...
def main(
   model_name,
   peft_model: Union[str,None]=None,
   ...
   min_length: Union[int,None]=None, #The minimum length of the sequence to be generated, input prompt + min_new_tokens
